...
export const handlers = [
  ...
  http.get('/api/analytics/tokens/daily', () => {
    return HttpResponse.json([
  ...
  http.get('/api/analytics/tokens/by-language', () => {
    return HttpResponse.json([
  ...
  http.get('/api/analytics/tokens/efficiency', () => {
    return HttpResponse.json([]);
  }),
  http.get('/api/analytics/sessions/:id/timeline', () => {
    return HttpResponse.json([]);
  }),
  http.get('/api/analytics/cost/by-task', () => HttpResponse.json(mockCostByTask)),
  http.get('/api/analytics/tokens/by-stage', () => HttpResponse.json(mockTokensByStage)),
  http.get('/api/analytics/sessions/summary', () => HttpResponse.json(mockSessionSummary)),
  http.get('/api/analytics/burn-rate', () => HttpResponse.json(mockBurnRate)),

  // Sessions
  http.get('/api/sessions', () => {
    return HttpResponse.json([]);
  }),
  http.post('/api/tasks/:id/sessions', () => {
